      ...
      {el.map((el) => (
        <>
          <div className="container partList" key={el._id}>
            <img alt="" src={el.logo} height="100" className="card__img logo" />
            <span className="vertical-line"></span>
            <div className="card__body middle-part">
              <h3 className="card__title">{el.title}</h3>
              <p className="card__description" style={{ minHeight: "50px" }}>
                {el.desc}
              </p>
              <div
                style={{
            ...
            <div className="last-part" style={{ width: "250px" }}>
