...
import { registerCustomer } from "../actions/authCustomerActions"
...
const Register = () => {
  ...
  // entre to ather router with isAuth
  const isAuth = useSelector(state => state.authCustomerReducer.isAuth)

  const dispatch = useDispatch()
  const navigate = useNavigate()
  // init satae de onChange and function //for the authCustomer else
